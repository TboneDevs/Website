#!/usr/bin/env python3
"""
CPM Web Tool - Full Updated Version for Railway
Includes all features from the new dashboard.html
"""
...
def run_async(coro):
    """Helper to safely run async CPM methods from Flask routes."""
    try:
